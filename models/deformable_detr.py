...
class DeformableDETR(nn.Module):
    ...
    def __init__(self, backbone, transformer, num_classes, num_queries, num_feature_levels,
                 aux_loss=True, with_box_refine=False, two_stage=False, finetune=False):
        ...
        self.class_embed = nn.Linear(hidden_dim, num_classes)  # classification head
        self.bbox_embed = MLP(hidden_dim, hidden_dim, 4, 3)   # box regression head
